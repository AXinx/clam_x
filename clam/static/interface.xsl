...
<xsl:template name="footer">
    <div id="footer" class="card">
        ...
        <p>Powered by <strong>CLAM</strong> v<xsl:value-of select="/clam/@version" /> <br />Ruyue Xin -
        <a href="https://github.com/AXinx/clam_x.git">https://github.com/AXinx/clam_x.git</a>
        <br /><a href="https://mns-research.nl/">Multiscale Networked System (MNS) group</a>, <a href="https://www.uva.nl/en">University Van Amsterdam</a><br />
        &amp; <a href="https://articonf.eu/">EU ARTICONF Project</a>
        </p>
    </div>
...
<xsl:template name="clamindex">
        ...
        <div id="startproject" class="card">
            <div class="card-body">
            	...
            	<p class="card-text">To create a new project, enter a short unique identifier below <em>(no spaces or special characters allowed)</em> and press the button:</p>
